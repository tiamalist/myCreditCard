...
namespace CC_3
{
    class Program
    {
        public static string NewCC = "";
        public static bool ValueBoolPerevirka;
        ...
        public static string GenerateNextCreditCardNumber(string s)
        {           
            for (int i = 0; i < s.Length; i++)
            {
                if (s[i] != ' ')
        ...
        public static bool Perevirka(string s)
        {
            
            switch (s[0])
            {
                case '3':
                    if ((s[1] == '4') && (NewCC[1] == '5')) // Перевірка другого символа вхідної строки "s" та перетвореної "NewCC"
                    {
                        ValueBoolPerevirka = ((s[1] == '4') && (NewCC[1] == '5')); //Присврєння bool значенння виразу в дужках змінній "k"
                    ...
                    {
                        ValueBoolPerevirka = ((s[1] == '7') && (NewCC[1] == '8'));
                        Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));              
                    }
                    else if ((s[2] == '8') && (NewCC[2] == '9'))
                    {
                        ValueBoolPerevirka = ((s[2] == '8') && (NewCC[2] == '9'));
                        Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));                        
                    }                   
                    break;
                ...
                case '4':
                    {
                        if ((s[0] == '4') && (NewCC[0] == '5'))
                        { 
                            ValueBoolPerevirka = ((s[0] == '4') && (NewCC[0] == '5'));                            
                            Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));                                                       
                        }
                    }                    
                    break;
                case '5':
                    if ((s[1] == '0') && (NewCC[1] == '1'))
                    {
                        ValueBoolPerevirka = ((s[1] == '0') && (NewCC[1] == '1'));
                        Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));                        
                    }
                    else if ((s[1] == '5') && (NewCC[1] == '6'))
                    {
                        ValueBoolPerevirka = ((s[1] == '5') && (NewCC[1] == '6'));
                        Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));                        
                    }                    
                    break;
                case '6':
                    if ((s[0] == '9') && (NewCC[0] == '0'))
                    {
                        ValueBoolPerevirka = ((s[0] == '9') && (NewCC[0] == '0'));
                        Console.WriteLine("Введений номер {0} остатнiй \"{1}\" валiдний iз дiапазону вендора", s, IsCreditCardNumberValid(s));                        
                    }
                    break;
            }
        
            return (ValueBoolPerevirka);
        }
